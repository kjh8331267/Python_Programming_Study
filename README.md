...
|6||[민수](https://github.com/seo-minsu)|제어문(조건문, 반복문), 에러와 예외처리|[코드](https://github.com/seo-minsu/Python-Programming-Study_Minsu/blob/main/_05_%EC%A0%9C%EC%96%B4%EB%AC%B8.ipynb)|
|7||소희|입력과 출력|코드|
|8||명주|함수|코드|
|9||고관|객체와 클래스|코드|
|10||소희|모듈과 패키지|코드|
